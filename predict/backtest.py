...
def run_backtest(conn):
    ...
    preds = cross_val_predict(LogisticRegression(max_iter=5000, C=0.05, l1_ratio=1.0, solver="saga"), Xs, y_1x2, cv=skf)
    ...
    preds = cross_val_predict(LogisticRegression(max_iter=5000, C=0.05, l1_ratio=1.0, solver="saga"), Xs, y_btts, cv=skf)
